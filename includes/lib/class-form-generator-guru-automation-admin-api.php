 ...
 * Admin API class.
 */
class Form_Generator_Guru_Automation_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'form-generator-guru-automation' ) . '" data-uploader_button_text="' . __( 'Use image', 'form-generator-guru-automation' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'form-generator-guru-automation' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'form-generator-guru-automation' ) . '" />' . "\n";
